...
"""
    raas-v2.models.order_model

    This file was automatically generated for Tango Card, Inc. by APIMATIC v2.0 ( https://apimatic.io )
"""
from raas-v2.api_helper import APIHelper
import raas-v2.models.currency_breakdown
import raas-v2.models.reward
import raas-v2.models.name_email
...
class OrderModel(object):
    ...
    def from_dictionary(cls,
        ...
        amount_charged = raas-v2.models.currency_breakdown.CurrencyBreakdownModel.from_dictionary(dictionary.get("amountCharged")) if dictionary.get("amountCharged") else None
        ...
        denomination = raas-v2.models.currency_breakdown.CurrencyBreakdownModel.from_dictionary(dictionary.get("denomination")) if dictionary.get("denomination") else None
        reference_order_id = dictionary.get("referenceOrderID")
        reward = raas-v2.models.reward.RewardModel.from_dictionary(dictionary.get("reward")) if dictionary.get("reward") else None
        ...
        recipient = raas-v2.models.name_email.NameEmailModel.from_dictionary(dictionary.get("recipient")) if dictionary.get("recipient") else None
        sender = raas-v2.models.name_email.NameEmailModel.from_dictionary(dictionary.get("sender")) if dictionary.get("sender") else None
