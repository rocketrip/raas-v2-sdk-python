...
"""
    raas_v2.models.raas_5xx_exception
...
import raas_v2.models.raas_5xx_error_model

class RaaS5xxException(raas_v2.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get("errors") != None:
            ...
            for structure in dictionary.get("errors"):
                self.errors.append(raas_v2.models.raas_5xx_error_model.RaaS5xxErrorModel.from_dictionary(structure))
